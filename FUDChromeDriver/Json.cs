...
namespace FUDChromeDriver
{
    public static class Json
    {
        ...
        {
            Dictionary<string, object>? obj = JsonConvert.DeserializeObject<Dictionary<string, object>>(data);
        ...
        {
            return DeserializeData(data.ToObject<Dictionary<string, object>>() ?? new());
        }
